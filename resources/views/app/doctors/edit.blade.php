...
<div>
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-light">
      ...
      <li class="breadcrumb-item active" aria-current="page">@lang('crud.doctores.edit_title')</li>
    </ol>
  </nav>
</div>
<br>
  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <x-form method="PUT" enctype="multipart/form-data" action="{{ route('doctors.update', $doctor) }}" class="mt-4">
          @csrf
